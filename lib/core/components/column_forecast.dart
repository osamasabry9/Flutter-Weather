  ...
  Widget build(BuildContext context) {
    List<Widget> forecastLongList = [
      ...
      Container(
          ...
          child: Text(
            description,
            style: TextStyle(fontSize: 12.0, color: Color(0xffa29fbc)),
          )),
      Container(
        margin: EdgeInsets.only(bottom: 20.0, top: 20.0, left: 5.0, right: 5.0),
        child: Image(
          width: 70.0,
          image: assetImage,
        ),
    ...
    List<Widget> forecastShortList = [
      Column(
        children: [
          ...
          Container(
            margin:
                EdgeInsets.only(bottom: 20.0, top: 25.0, left: 5.0, right: 5.0),
            child: Container(
